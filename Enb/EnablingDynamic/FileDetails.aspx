<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FileDetails.aspx.cs" Inherits="FileDetails" %>
            ...
            <div class="mainbar">
                ...
                <div style="padding: 22px 0 10px 0">
                    <asp:GridView ID="GridFileView" runat="server" CssClass="CSSTableGenerator" HeaderStyle-BackColor="#3673AB"
                        ...
                        onrowdeleting="GridFileView_RowDeleting">
                        <Columns>
                             ...
                             <asp:TemplateField HeaderText="Action" HeaderStyle-Height="30px" HeaderStyle-Width="90px"
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgappbutt" runat="server" CommandName="Download" Height="30"
                                        Width="90" CommandArgument='<%#Eval("Files_FilePath") %>' ImageUrl="images/download.png" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Action" HeaderStyle-Height="30px" HeaderStyle-Width="90px"
                                ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgappDelete" runat="server" CommandName="Delete" Height="30"
                                        Width="30" CommandArgument='<%#Eval("Files_Id") %>' ImageUrl="images/DeleteRed.png" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
