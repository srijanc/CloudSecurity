<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="TPAGetFiles.aspx.cs" Inherits="TPAGetFiles" %>
                ...
                <div style="padding: 22px 0 10px 10px">
                    <asp:GridView ID="GridFileView" runat="server" CssClass="CSSTableGenerator" HeaderStyle-BackColor="#3673AB"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Sent Request" HeaderStyle-Height="30px" HeaderStyle-Width="60px"
                                ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgappbutt" runat="server" CommandName="Send" CommandArgument='<%#Eval("Files_Id") %>'
                                        ImageUrl="images/send_request_button.png" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
