<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="UserRequestForFile.aspx.cs" Inherits="UserRequestForFile" %>
            ...
            <div class="mainbar">
                ...
                <div style="padding: 22px 0 10px 0">
                    <asp:GridView ID="GridFileView" runat="server" CssClass="CSSTableGenerator" HeaderStyle-BackColor="#3673AB"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Requester Name" HeaderStyle-Height="30px" HeaderStyle-Width="180px"
                            ...
                            <asp:TemplateField HeaderText="Requester Email" HeaderStyle-Height="30px" HeaderStyle-Width="180px"
                                ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                <ItemTemplate>
