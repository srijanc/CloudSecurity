<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="CloudUserReg.aspx.cs" Inherits="CloudUserReg" %>
...
<script type="text/javascript">
    function validation() {
        ...
        if (document.getElementById("<%=TxtDOB.ClientID%>").value == "" || document.getElementById("<%=TxtDOB.ClientID%>").value == null) {
            msg = msg + " DOB can not be blank\n";
        }
    ...
    <div class="content">
        <div class="content_resize">
            <div class="mainbar">
                ...
                <div style="padding: 22px 0 10px 51px">
