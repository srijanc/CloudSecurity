...
namespace Online_DataAccessLayer
{
    public class SQlDataAccess
    {
        ...
        private string _ConnectionString = ConfigurationManager.ConnectionStrings["ApplicationCon"].ToString();
        ...
        {
            return ConfigurationManager.ConnectionStrings["ApplicationCon"].ToString();
        }
